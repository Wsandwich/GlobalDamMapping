...
def run_dof(stamp=None):
    ...
    dam_folder = '/mnt/bf9340de-26bc-4032-9f11-494ba8ad1b3a/wyj/data/Controlled_experiment/dam_with_rivers/GDAT_with_rivers_03'
    streams_folder = '/mnt/bf9340de-26bc-4032-9f11-494ba8ad1b3a/wyj/data/rivers_by_basin_03'
    output_path = r"/mnt/bf9340de-26bc-4032-9f11-494ba8ad1b3a/wyj/data/Controlled_experiment/GDAT_dof_result"
    ...
    for streams_file in os.listdir(streams_folder):
        ...
        num_cores = 10  # Limit to prevent excessive memory usage
