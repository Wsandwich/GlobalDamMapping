...
if __name__ == '__main__':
    ...
    path_process_files = r"E:\研究生\project\data\Mapping the worlds free-flowing rivers_Data_Geodatabase\Mapping the worlds free-flowing rivers_Data_Geodatabase\free-flowing.gpkg"

    # Arquivo Excel
    xlsx_file = r"Free-Flowing-Rivers\config.xlsx" # os.path.join(basepath + r"\\config", "config.xlsx")
